...
Tree.prototype.countLeaves = function () {
  // TODO: implement me!
  // If this has children, call recursively
  // If this has no children, return 1
...
// var root = new Tree();
// const a = root.countLeaves(); // 1
// root.addChild(new Tree());
// const b = root.countLeaves(); // still 1
// root.addChild(new Tree());
// root.children[0].addChild(new Tree());
// root.children[0].addChild(new Tree());
// root.children[0].children[0].addChild(new Tree());
// const c = root.countLeaves(); // 3
